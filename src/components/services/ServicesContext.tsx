export default function ServicesContext() {
  return (
    <section className="bg-black">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="border border-white/10 bg-white/5 px-6 py-10 md:px-10">
          <div className="max-w-4xl">
            <h2 className="text-2xl font-semibold tracking-tight text-white">
              Most operational issues don’t announce themselves clearly.
            </h2>
            ...
            <p className="mt-4 text-base leading-relaxed text-white/70">
              This isn’t a lack of effort or talent. It’s usually a breakdown in how decisions move, how work flows,
              or how responsibility is distributed.
            </p>
